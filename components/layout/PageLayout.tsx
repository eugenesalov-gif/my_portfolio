...
export default function PageLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto flex flex-col gap-10 px-1 py-3 pb-6 items-start min-[810px]:px-6 min-[810px]:py-6 min-[810px]:pb-8 min-[1200px]:flex-row min-[1200px]:gap-[60px]">
